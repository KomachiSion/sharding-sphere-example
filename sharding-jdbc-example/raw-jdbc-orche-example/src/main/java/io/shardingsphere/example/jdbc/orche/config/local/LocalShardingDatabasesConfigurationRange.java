...
public final class LocalShardingDatabasesConfigurationRange implements ExampleConfiguration {
    
    private final RegistryCenterConfiguration registryCenterConfig;
    
    public LocalShardingDatabasesConfigurationRange(final RegistryCenterConfiguration registryCenterConfig) {
    ...
    public DataSource getDataSource() throws SQLException {
        ...
        return OrchestrationShardingDataSourceFactory.createDataSource(createDataSourceMap(), shardingRuleConfig, new HashMap<String, Object>(), new Properties(), orchestrationConfig, new SagaConfiguration());
    }
